...
CAPABILITIES: Dict[str, ActionDefinition] = {
    ...
    "update_pipeline_schedule": ActionDefinition(
        ...
        description="Update pipeline sync schedule frequency",
        category=ActionCategory.PIPELINES,
        method="PUT",
        ...
        parameters=[
            Parameter("id", "Pipeline ID", required=False, example="12345"),
            Parameter("name", "Pipeline name", required=False, example="Salesforce_to_Snowflake"),
            Parameter("frequency", "Frequency interval in minutes", required=True, param_type="integer", example="15"),
        ],
        examples=["Set pipeline to sync every 15 minutes", "Update sync frequency to 30 minutes"],
        follow_ups=["get_pipeline"],
        implemented=True,
    ),
    "update_pipeline_priority": ActionDefinition(
        name="update_pipeline_priority",
        description="Update pipeline priority (HIGH or NORMAL)",
        category=ActionCategory.PIPELINES,
        method="PUT",
        ...
        parameters=[
            Parameter("id", "Pipeline ID", required=False, example="12345"),
            Parameter("name", "Pipeline name", required=False, example="Salesforce_to_Snowflake"),
            Parameter("priority", "Priority level (HIGH or NORMAL)", required=True, example="HIGH"),
        ],
        examples=["Set pipeline priority to high", "Change priority to normal"],
        follow_ups=["get_pipeline"],
        implemented=True,
    ),
    ...
    "get_pipeline_position": ActionDefinition(
        name="get_pipeline_position",
        description="Get position for a log-based pipeline",
        category=ActionCategory.PIPELINES,
        method="GET",
        endpoint="/pipelines/{id}/position",
        parameters=[
            Parameter("id", "Pipeline ID", required=False, example="12345"),
            Parameter("name", "Pipeline name", required=False, example="MySQL_to_Snowflake"),
        ],
        examples=["Get pipeline position", "Show log position"],
        follow_ups=["update_pipeline_position"],
        implemented=True,
    ),
    "update_pipeline_position": ActionDefinition(
        name="update_pipeline_position",
        description="Update position for a log-based pipeline",
        category=ActionCategory.PIPELINES,
        method="PUT",
        endpoint="/pipelines/{id}/position",
        parameters=[
            Parameter("id", "Pipeline ID", required=False, example="12345"),
            Parameter("name", "Pipeline name", required=False, example="MySQL_to_Snowflake"),
            Parameter("file_name", "Log file name being processed", required=False),
            Parameter("offset", "Byte offset position in the log file", required=False, param_type="integer"),
        ],
        examples=["Update pipeline position", "Set log offset"],
    ...
    "get_object_position": ActionDefinition(
        name="get_object_position",
        description="Get position for a specific object in a pipeline",
        category=ActionCategory.OBJECTS,
        method="GET",
        endpoint="/pipelines/{id}/objects/{name}/position",
        parameters=[
            Parameter("pipeline_id", "Pipeline ID", required=True, example="12345"),
            Parameter("object_name", "Object/table name", required=True, example="users"),
        ],
        examples=["Get object position", "Show sync position for users table"],
        follow_ups=["update_object_position"],
        implemented=True,
    ),
    "update_object_position": ActionDefinition(
        name="update_object_position",
        description="Update position for a specific object in a pipeline",
        category=ActionCategory.OBJECTS,
        method="PUT",
        endpoint="/pipelines/{id}/objects/{name}/position",
        parameters=[
            Parameter("pipeline_id", "Pipeline ID", required=True, example="12345"),
            Parameter("object_name", "Object/table name", required=True, example="users"),
            Parameter("time", "Timestamp value for position", required=False, param_type="integer"),
            Parameter("month", "Month component for date-based positioning", required=False, param_type="integer"),
            Parameter("year", "Year component for date-based positioning", required=False, param_type="integer"),
            Parameter("key_values", "Map of key-value pairs for object-based position", required=False, param_type="object"),
        ],
        examples=["Update object position", "Set sync position for users table"],
        follow_ups=["get_object_position"],
        implemented=True,
    ),
    ...
    "create_model": ActionDefinition(
        ...
        endpoint="/models",
        parameters=[
            Parameter("source_destination_id", "Source destination ID for query execution", required=True, example="123"),
            Parameter("name", "Model name", required=True, example="daily_summary"),
            Parameter("source_query", "SQL query", required=True),
            Parameter("table_name", "Destination table name", required=True, example="daily_sales"),
            Parameter("primary_keys", "List of primary key columns", required=False, param_type="array"),
            Parameter("load_type", "TRUNCATE_AND_LOAD or INCREMENTAL_LOAD", required=False, example="TRUNCATE_AND_LOAD"),
            Parameter("schedule", "Schedule config (type, frequency, cron_expression)", required=False, param_type="object"),
        ],
    ...
    "update_model": ActionDefinition(
        ...
        parameters=[
            Parameter("id", "Model ID", required=False, example="456"),
            Parameter("name", "Model name (to find model)", required=False, example="daily_summary"),
            Parameter("new_name", "New model name", required=False),
            Parameter("source_query", "New SQL query", required=False),
            Parameter("table_name", "Destination table name", required=False),
            Parameter("primary_keys", "List of primary key columns", required=False, param_type="array"),
            Parameter("load_type", "TRUNCATE_AND_LOAD or INCREMENTAL_LOAD", required=False),
        ],
